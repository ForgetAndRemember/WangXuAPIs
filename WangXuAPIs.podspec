...
Pod::Spec.new do |s|
  s.name             = 'WangXuAPIs'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WangXuAPIs.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gitWangxu/WangXuAPIs'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gitWangxu' => '1965584294@qq.com' }
  s.source           = { :git => 'https://github.com/gitWangxu/WangXuAPIs.git', :tag => s.version.to_s }
